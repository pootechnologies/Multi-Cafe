...
class SupplierSerializer(serializers.ModelSerializer):
    class Meta:
        model = Supplier
        # fields = ['id', 'name', 'contact_info', 'tin_number', 'user']
        fields = '__all__'
...
class ProductGetSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'name', 'category', 'category_name', 'specification', 'description', 'package', 'piece', 'unit', 'buying_price', 'selling_price', 'receipt_no', 'specification', 'stock', 'supplier_name', 'image', 'user']
        constraints = [
...
class OrderItemSerializer(serializers.ModelSerializer):
    ...
    def update(self, instance, validated_data):
        ...
        user = self.context['request'].user
        user_role = user.is_superuser
        # If a salesman tries to cancel, set to Pending and raise error
        if new_status == 'Cancelled' and user_role == False:
...
class OrderSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Order
        fields = ['id', 'customer', 'customer_name', 'customer_fs', 'status', 'receipt', 'receipt_id', 'order_date', 'vat_type', 'sub_total', 'vat',  'total_amount', 'payment_status', 'paid_amount', 'unpaid_amount', 'credit', 'items', 'user', 'ordered_by']
        extra_kwargs = {
...
class OrderLogSerializer(serializers.ModelSerializer):
    class Meta:
        model = OrderLog
        fields = ['id', 'action', 'model_name', 'object_id', 'customer_info', 'product_name', 'product_specification', 'quantity', 'price', 'changes_on_update', 'timestamp', 'user']
